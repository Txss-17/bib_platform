...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "hero.desc": "LINKSY est la plateforme de commerce intelligente qui vous permet de lancer, gérer et développer votre activité en ligne — avec une transparence totale, des insights intelligents et une protection intégrée.",
    ...
    "features.desc": "LINKSY est bien plus qu'une marketplace — c'est un système complet conçu pour lancer, développer et protéger votre activité en ligne.",
    ...
    "how.title2": "succès",
    "how.desc": "De la création de compte au développement de votre activité — LINKSY vous guide à chaque étape avec transparence et support.",
    ...
    "how.step3.desc": "Parcourez les produits validés par LINKSY avec indicateurs de demande, notes fournisseurs et visibilité des marges.",
    ...
    "trust.desc": "LINKSY repose sur la transparence et la confiance. Chaque fonctionnalité protège votre activité, guide vos décisions et responsabilise tout le monde — y compris nous.",
    ...
    "trust.fair.desc": "Conditions claires, frais visibles, aucun coût caché. LINKSY grandit avec vous, pas à vos dépens.",

    // CTA
    "cta.badge": "Commencez aujourd'hui",
    "cta.title": "Prêt à bâtir votre empire commercial ?",
    "cta.desc": "Rejoignez des milliers d'entrepreneurs qui font confiance à LINKSY pour lancer, développer et protéger leur activité. Sans carte bancaire.",
    ...
    "login.branding.title": "Développez votre activité avec LINKSY",
    ...
    "signup.desc": "Commencez votre aventure vendeur avec LINKSY",
    ...
    "signup.branding.title": "Commencez à vendre avec LINKSY dès aujourd'hui",
    "signup.branding.desc": "Rejoignez des milliers d'entrepreneurs qui font confiance à LINKSY pour développer leur activité.",
    ...
    "signup.social": "vendeurs font déjà confiance à LINKSY",
  ...
  en: {
    ...
    "hero.desc": "LINKSY is the intelligent commerce platform that empowers you to launch, manage, and grow your online business—with complete transparency, smart insights, and built-in protection.",
    ...
    "features.desc": "LINKSY is more than a marketplace—it's a complete business operating system designed to help you launch, scale, and protect your online business.",
    ...
    "how.title2": "Success",
    "how.desc": "From account creation to scaling your business—LINKSY guides you every step of the way with transparency and support.",
    ...
    "how.step3.desc": "Browse LINKSY-validated products with transparent demand indicators, supplier ratings, and margin visibility. Add video content for authenticity.",
    ...
    "trust.desc": "LINKSY is built on transparency and trust. Every feature is designed to protect your business, guide your decisions, and hold everyone—including us—accountable.",
    ...
    "trust.fair.desc": "Clear terms, visible fees, and no hidden costs. LINKSY grows with you, not on your back.",

    // CTA
    "cta.badge": "Start your journey today",
    "cta.title": "Ready to Build Your Business Empire?",
    "cta.desc": "Join thousands of entrepreneurs who trust LINKSY to launch, scale, and protect their online business. No credit card required.",
    ...
    "login.branding.title": "Grow your business with LINKSY",
    ...
    "signup.desc": "Start your seller journey with LINKSY",
    ...
    "signup.branding.title": "Start selling with LINKSY today",
    "signup.branding.desc": "Join thousands of entrepreneurs who trust LINKSY to grow their online business.",
    "signup.multiboutique": "Multi-Boutique",
    ...
    "signup.social": "sellers already trust LINKSY",
